...
internal sealed class ProductEditorProductDataService : IProductEditorProductDataService
{
    public ProductEditorProductDataService(
    ...
    public async Task<List<ProductEditorProductData>> GetProductEditorProductDatasAsync(List<Product> products)
    {
        ...
        List<ProductImagesForProductCountData> localImagesCount
            = await _productImageService.GetCountOfAllInProductsAsync(productIds);
        ...
        {
            LegacyXmlProduct? xmlProduct = getProductXmlDataResult.Match(
            ...
            ProductImagesForProductCountData? productImagesForProductCountData = localImagesCount
                .FirstOrDefault(x => x.ProductId == product.Id);
            ...
            ProductEditorProductData entryForProduct = await GetProductEditorProductDataFromSharedDataInternalAsync(
                ...
                productImagesForProductCountData?.ImageCount ?? 0,
    ...
    public async Task<ProductEditorProductData> GetProductEditorProductDataAsync(Product product)
    {
        OneOf<LegacyXmlObjectData, InvalidXmlResult, NotFound> getProductXmlDataResult
            = await _productXmlProvidingService.GetProductXmlParsedAsync();
        ...
        int? promotionFilesCount = null)
    {
        ...
        localImagesCount ??= await _productImageService.GetCountOfAllInProductAsync(product.Id);
        ...
        ProductEditorProductData imagesCompareTableEntry = new()
        {
            ...
            LocalImagesCount = localImagesCount ?? 0,
