...
internal sealed class ServiceProductGTINCodeCreateRequestValidator : AbstractValidator<ServiceProductGTINCodeCreateRequest>
{
    public ServiceProductGTINCodeCreateRequestValidator()
    {
        ...
        RuleFor(x => x.CreateUserName).NotEmpty().MaximumLength(CreateUserNameMaxLength);
    }
}