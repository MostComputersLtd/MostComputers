...
internal sealed class XmlImportProductFirstImageUpdateRequestValidator : AbstractValidator<XmlImportServiceProductFirstImageUpdateRequest>
{
    public XmlImportProductFirstImageUpdateRequestValidator()
    {
