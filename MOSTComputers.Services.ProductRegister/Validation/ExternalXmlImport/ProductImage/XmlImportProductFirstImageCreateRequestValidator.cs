...
internal sealed class XmlImportProductFirstImageCreateRequestValidator : AbstractValidator<XmlImportServiceProductFirstImageCreateRequest>
{
    public XmlImportProductFirstImageCreateRequestValidator()
    {
