...
internal class ProductCreateWithoutImagesInDatabaseRequestValidator : AbstractValidator<ProductCreateWithoutImagesInDatabaseRequest>
{
    public ProductCreateWithoutImagesInDatabaseRequestValidator()
    {
