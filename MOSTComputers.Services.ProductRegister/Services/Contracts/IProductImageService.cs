...
public interface IProductImageService
{
    ...
    IEnumerable<ProductImage> GetAllFirstImagesForSelectionOfProducts(List<uint> productIds);
    ...
    OneOf<uint, ValidationResult, UnexpectedFailureResult> InsertInAllImages(ServiceProductImageCreateRequest createRequest, IValidator<ServiceProductImageCreateRequest>? validator = null);
