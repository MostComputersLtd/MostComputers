...
public interface IGroupPromotionImageFileDataService
{
    ...
    Task<OneOf<Success, NotFound, ValidationResult>> UpdateAsync(GroupPromotionImageFileDataUpdateRequest updateRequest);
