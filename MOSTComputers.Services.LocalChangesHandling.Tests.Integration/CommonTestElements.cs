...
internal static class CommonTestElements
{
    ...
    internal static ProductFullUpdateRequest GetValidProductFullUpdateRequestWithNoImages(int id, int? categoryId = 7, short? manifacturerId = 12, int? subCategoryId = null)
    {
        return new()
        {
            Id = id,
