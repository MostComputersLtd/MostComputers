...
public sealed class ProductCharacteristicServiceTests : IntegrationTestBaseForNonWebProjects
{
    ...
    public void GetSelectionByCategoryIdAndNames_ShouldSucceed_WhenInsertIsValid()
    {
        ...
        ProductCharacteristicCreateRequest validCreateRequest1 = GetValidCreateRequest((int)categoryId, nameOfCreateRequest1);
        ProductCharacteristicCreateRequest validCreateRequest2 = GetValidCreateRequest((int)categoryId, nameOfCreateRequest2);
