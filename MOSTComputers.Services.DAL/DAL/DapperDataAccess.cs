...
public interface IRelationalDataAccess
{
    ...
    T? GetDataFirstOrDefault<T, U>(string sqlStatement, U parameters, IDbConnection dbConnection, IDbTransaction? transaction = null);
    ...
    int SaveData<T>(string sqlStatement, T parameters, bool doInTransaction = false);
    T? SaveDataAndReturnValue<T, U>(string sqlStatement, U parameters, bool doInTransaction = false);

    int SaveDataStoredProcedure<T>(string storedProcedureName, T parameters, bool doInTransaction = false);
    ...
    TReturn SaveDataInTransactionScopeUsingActionAndCommitOnCondition<TReturn>(Func<IDbConnection, TReturn> actionInTransaction, Predicate<TReturn> shouldCommit);
    ...
    TReturn SaveDataInTransactionScopeUsingActionAndCommitOnCondition<U, TReturn>(Func<IDbConnection, U, TReturn> actionInTransaction, Predicate<TReturn> shouldCommit, U parameters);
    ...
    Task<TReturn> SaveDataInTransactionScopeUsingActionAndCommitOnConditionAsync<TReturn>(Func<IDbConnection, Task<TReturn>> actionInTransaction, Predicate<TReturn> shouldCommit);
    ...
    Task<TReturn> SaveDataInTransactionScopeUsingActionAndCommitOnConditionAsync<U, TReturn>(Func<IDbConnection, U, Task<TReturn>> actionInTransaction, Predicate<TReturn> shouldCommit, U parameters);
}
...
internal class DapperDataAccess : IRelationalDataAccess
{
    ...
    public T? GetDataFirstOrDefault<T, U>(string sqlStatement, U parameters, IDbConnection dbConnection, IDbTransaction? transaction = null)
    {
    ...
    public int SaveData<T>(string sqlStatement, T parameters, bool doInTransaction = false)
    {
        using IDbConnection connection = new SqlConnection(_connectionString);
    ...
    public int SaveDataStoredProcedure<T>(string storedProcedureName, T parameters, bool doInTransaction = false)
    {
        using IDbConnection connection = new SqlConnection(_connectionString);
    ...
    public TReturn SaveDataInTransactionScopeUsingActionAndCommitOnCondition<TReturn>(
        Func<IDbConnection, TReturn> actionInTransaction,
        Predicate<TReturn> shouldCommit)
    {
        using TransactionScope scope = new();
        ...
        TReturn data = actionInTransaction(connection);
    ...
    public TReturn SaveDataInTransactionScopeUsingActionAndCommitOnCondition<U, TReturn>(
        Func<IDbConnection, U, TReturn> actionInTransaction,
        Predicate<TReturn> shouldCommit,
        U parameters)
    {
        using TransactionScope scope = new();
    ...
    public async Task<TReturn> SaveDataInTransactionScopeUsingActionAndCommitOnConditionAsync<TReturn>(
        Func<IDbConnection, Task<TReturn>> actionInTransaction,
        Predicate<TReturn> shouldCommit)
    {
        using TransactionScope scope = new(TransactionScopeAsyncFlowOption.Enabled);
        ...
        TReturn data = await actionInTransaction(connection);
    ...
    public async Task<TReturn> SaveDataInTransactionScopeUsingActionAndCommitOnConditionAsync<U, TReturn>(
        Func<IDbConnection, U, Task<TReturn>> actionInTransaction,
        Predicate<TReturn> shouldCommit,
        U parameters)
    {
        using TransactionScope scope = new(TransactionScopeAsyncFlowOption.Enabled);
        ...
        TReturn data = await actionInTransaction(connection, parameters);
